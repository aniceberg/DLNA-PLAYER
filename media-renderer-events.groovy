...
definition(
	...
	author: "SmartThings",
	description: "Play a sound, Radionomy station or custom message through your MediaRenderer or Sonos when the mode changes or other events occur.",
...
preferences {
    ...
    page(name: "ttsKey", title: "Add the Text for Speech Key")
    page(name: "ttsSettings", title: "Text for Speech Settings")
...
def mainPage() {
	dynamicPage(name: "mainPage") {
        ...
        section{  
        	...
        	input "sound", "enum", title: "Play this Sound?", required: actionType == "Sound"? true:flase, defaultValue: "Bell 1", options: [
            "Bell 1",
            "Bell 2",
            "Dogs Barking",
            "Fire Alarm",
        ...
        section{  
        	href "ttsSettings", title: "Text for Speech Settings",required:flase, description:ttsMode
        }
		section {
	...
	dynamicPage(name: "ttsSettings") {
        def languageOptions = ["ca-es":"Catalan","zh-cn":"Chinese (China)","zh-hk":"Chinese (Hong Kong)","zh-tw":"Chinese (Taiwan)","da-dk":"Danish","nl-nl":"Dutch","en-au":"English (Australia)","en-ca":"English (Canada)","en-gb":"English (Great Britain)","en-in":"English (India)","en-us":"English (United States)","fi-fi":"Finnish","fr-ca":"French (Canada)","fr-fr":"French (France)","de-de":"German","it-it":"Italian","ja-jp":"Japanese","ko-kr":"Korean","nb-no":"Norwegian","pl-pl":"Polish","pt-br":"Portuguese (Brazil)","pt-pt":"Portuguese (Portugal)","ru-ru":"Russian","es-mx":"Spanish (Mexico)","es-es":"Spanish (Spain)","sv-se":"Swedish (Sweden)"]
 		section() {
            ...
            input "ttsMode", "enum", title: "Mode?", required: true, defaultValue: "SmartThings",submitOnChange:true, options: ["SmartThings","Voice RSS","Google","Alexa"]
...
private loadText() {
	switch (sound) {
        ...
        case "Piano":
			...
			break;
		case "Siren":
        	state.sound = [uri: "http://soundbible.com/mp3/Siren-SoundBible.com-1094437108.mp3", duration: "10"]
			break;
		case "Warning Siren":
        	state.sound = [uri: "http://soundbible.com/mp3/Warning%20Siren-SoundBible.com-898272278.mp3", duration: "10"]
			break;
        case "Steam Train Whistle":
        	state.sound = [uri: "http://soundbible.com/mp3/steam-train-whistle-daniel_simon.mp3", duration: "10"]
			break;
         case "Toilet Flush":
        	state.sound = [uri: "http://soundbible.com/mp3/toilet_flush_clear-mike-koenig.mp3", duration: "10"]
			break;
        case "Train Approach":
        	state.sound = [uri: "http://soundbible.com/mp3/Train_Approach_n_Pass-Mike_Koenig-678807208.mp3", duration: "15"]
			break;
        case "Train Horn":
       	 state.sound = [uri: "http://soundbible.com/mp3/Train_Honk_Horn_2x-Mike_Koenig-157974048.mp3", duration: "10"]
			break;
